      ...
      <div className='bottom'>
        ...
        <div className="sponsors">
          ...
          <div className='sponsorship-links'>
            <a className='sponsorship-link' href="https://www.fbafitness.com/content/fitness-business-association-1" target='_blank' rel="noopener noreferrer">
              <img className="img1" src="/Pictures/fba-logo5-1024x614.png" alt="Sponsor 2"></img>
            </a>
            <a  className='sponsor-link' href="https://www.ihrsa.org/">
