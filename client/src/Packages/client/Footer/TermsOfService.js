...
return (
<div>
<h1 className="start">TERMS OF SERVICE</h1>
<br></br>
<p>Last updated March 18, 2023</p>
<br></br>
<h2>AGREEMENT TO OUR LEGAL TERMS</h2>
  <p>
    We are Altitude Fitness, LLC, doing business as Altitude Fitness
    Management Group ("Company," "we," "us," "our"), a company registered in
    New Jersey, United States at 800 Catalpa Avenue, Teaneck, NJ 07666.
  </p>
  <p>
    We operate the website{" "}
    <a
      href="http://www.altitudefitlife.com"
      target="_blank"
      rel="noopener noreferrer"
    >
      http://www.altitudefitlife.com
    </a>{" "}
  ...
  <p>
    We provide business and management consulting services to the fitness
    industry. We are known as the design leaders in fitness consulting
    because we tailor services to each individual business based on the
    needs of the business. We provide a wide range of solutions however, tend
    to service those solutions that are technology focused to increase
    productivity and increase revenue.
  </p>
  <p>
    You can contact us by phone at (646) 974-8677, email at{" "}
    <a href="mailto:altitudefitmgmt@altitudefitlife.com">
      altitudefitmgmt@altitudefitlife.com
    </a>
    , or by mail to 500 7th Avenue, 8th Floor, New York, NY 10018, United
    States.
  </p>
  <p>
    These Legal Terms constitute a legally binding agreement made between
    you, whether personally or on behalf of an entity ("you"), and Altitude
    Fitness, LLC, concerning your access to and use of the Services. You
  ...
  <p>
    ...
    upon posting or notifying you by altitudefitmgmt@altitudefitlife.com, as
  ...
  <h2>Table of Contents</h2>
      ...
      <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: altitudefitmgmt@altitudefitlife.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
      <p>We reserve all rights not expressly granted to you in and to the Services, Content, and Marks.</p>
        <p>Any breach of these Intellectual Property Rights will consitute a material breach of our Legal Terms and your right to use our Services will terminate immediately</p>
         <h2>Please review this section and the "PROHIBITED ACTIVITIES" section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.</h2>
         <br></br>
      <h3>Submissions</h3>
    ...
    <h2>Prohibited Activities</h2>
      ...
      <ul>
        ...
        <li>
          ...
          interferes with any partys uninterrupted use and enjoyment of the
...
<li>Capture or record information displayed on site.</li>
</ul>
<br></br>
 <p>The Services may invite you to chat, contribute to, or participate in blogs, message boards, online forums, and other functionality, and may provide you with the opportunity to create, submit, post, display, transmit, perform, publish, distribute, or broadcast content and materials to us or on the Services, including but not limited to text, writings, video, audio, photographs, graphics, comments, suggestions, or personal information or other material (collectively, "Contributions"). Contributions may be viewable by other users of the Services and through third-party websites. As such, any Contributions you transmit may be treated as non-confidential and non-proprietary. When you create or make available any Contributions, you thereby represent and warrant that:</p>
    ...
    <h2>CONTRIBUTION LICENSE</h2>
      ...
      <ol>
        ...
        <li>Take appropriate legal action against anyone who violates the law or these Legal Terms, including reporting such user to law enforcement authorities, at our sole discretion</li>
        <li>Refuse, restrict access to, limit the availability of, or disable any of your Contributions or any portion thereof, at our sole discretion and without limitation, to the extent technologically feasible</li>
        <li>Remove from the Services or otherwise disable all files and content that are excessive in size or are in any way burdensome to our systems, at our sole discretion and without notice or liability</li>
    ...
    <p>
      ...
      <br></br>
        ...
        CAUSE OF ACTION ARISING OR $5,000.00 USD. CERTAIN US STATE LAWS AND
    ...
    <br></br>
      ...
      <br></br>
      <h2>Contact Us</h2>
      <p className="end"> Altitude Fitness, LLC<br />
        500 7th Avenue<br />
        8th Floor<br />
        New York , NY 10018<br />
        United States<br />
        Phone: (646) 974-8677<br />
        Fax: (646) 559-6685<br />
        altitudefitmgmt@altitudefitlife.com<br />
        </p>
