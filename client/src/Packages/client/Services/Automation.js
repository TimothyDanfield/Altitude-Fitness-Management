...
function Automation() {
  return (
    <div className="block">
      ...
      <ol>
        <li>
          <p className="text">Automated billing: Our gym management software allows you to automate your billing and payment processes, ensuring that you get paid on time and eliminating the need for manual invoicing and tracking. </p>
        </li>
        <li>
          <p className="text">Automated scheduling: Through Altitude Fitness software, we can help you streamline your scheduling process by automating class and appointment bookings, sending reminders to staff and clients, and managing waitlists and cancellations. </p>
        </li>
        <li>
          <p className="text">Automated member management: Our software can help you manage your member database, including signups, renewals, and cancellations. You can also track member attendance and preferences, and send personalized communications to members based on their interests and needs. </p>
        </li>
        <li>
