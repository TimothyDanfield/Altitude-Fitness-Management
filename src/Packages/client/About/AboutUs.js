      ...
      <div className="main__container_1">
        <div className="main__img--container_1">
          <div className="main__img--card_1">
             {/* <img src="/public/Pictures/wallpaperflare.com_wallpaper.jpg">  */}
          </div>
        </div>
    ...
    <div className="mainMark reveal" id="sign-up">
      <div className="main__container_2">
        <div className="main__content_2">
          ...
          <p>
            Marketing is an essential part of any business strategy. It helps to
            reach out to potential customers, increase brand awareness, and
            boost revenue. Business marketing involves a set of activities that
            help to promote a product or service to a target audience. It
